...
<?php 
    ...
    if($_POST){ 
        ...
        if( empty( $_POST['grau_de_Escolaridade'] ) ){
            echo "<p>grau_de_ Escolaridade Invalido";
        }
        ...
        echo "<p>grau_de_Escolaridade: " . $_POST['grau_de_Escolaridade'] . "</br>";
...
<form action="" method="post">
    ...
    Grau de escolaridade: <input type=text name="grau_de_Escolaridade"> </br>
